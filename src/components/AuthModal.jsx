      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl border border-slate-100 overflow-hidden">
        ...
        <div className="flex border-b border-slate-100 bg-slate-50 text-sm font-semibold">
          <button
            ...
            className={`flex-1 py-3 text-center transition ${mode === "login" ? "bg-white text-emerald-800 border-b-2 border-emerald-600" : "text-slate-500 hover:text-slate-900"}`}
          >
            Sign In
          </button>
          <button
            onClick={() => { setMode("register"); setError(""); }}
            className={`flex-1 py-3 text-center transition ${mode === "register" ? "bg-white text-emerald-800 border-b-2 border-emerald-600" : "text-slate-500 hover:text-slate-900"}`}
          >
            New Registration
          </button>
        </div>
