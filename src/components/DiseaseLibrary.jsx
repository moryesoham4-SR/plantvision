        ...
        <div className="flex bg-slate-100 p-1 rounded-xl w-full sm:w-auto text-xs font-bold">
          <button
            ...
            className={`flex-1 sm:flex-initial px-4 py-2 rounded-lg transition ${
              selectedCrop === "potato" ? "bg-white text-emerald-800 shadow-xs" : "text-slate-600 hover:text-slate-900"
            }`}
          >
            🥔 Potato
          </button>
          <button
            ...
            className={`flex-1 sm:flex-initial px-4 py-2 rounded-lg transition ${
              selectedCrop === "tomato" ? "bg-white text-emerald-800 shadow-xs" : "text-slate-600 hover:text-slate-900"
            }`}
          >
            🍅 Tomato
          </button>
          <button
            ...
            className={`flex-1 sm:flex-initial px-4 py-2 rounded-lg transition ${
              selectedCrop === "apple" ? "bg-white text-emerald-800 shadow-xs" : "text-slate-600 hover:text-slate-900"
            }`}
          >
            🍎 Apple
          </button>
