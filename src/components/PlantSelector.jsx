        ...
        {PLANTS.map((plant) => {
          ...
          return (
            <div
              ...
              className={`relative p-3.5 rounded-xl border-2 transition text-left select-none ${
                isActive
                  ? isSelected
                    ? "bg-emerald-50/90 border-emerald-600 shadow-md shadow-emerald-500/10 cursor-pointer"
